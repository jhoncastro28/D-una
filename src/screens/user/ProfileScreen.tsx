...
const SAVED = MOCK_EVENTS.slice(0, 3);
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          <View style={styles.bigAvatar}>
            <Text style={styles.avatarInitials}>NC</Text>
          </View>
          <Text style={styles.name}>Nicolás Castro</Text>
          <Text style={styles.municipality}>📍 Tunja, Boyacá</Text>
          <Text style={styles.joined}>Miembro desde mayo 2026</Text>
        </View>

        {/* Estadísticas */}
        <View style={styles.statsRow}>
          <StatBox label="Eventos vistos" value="12" />
          <StatBox label="Guardados" value="3" />
          <StatBox label="Municipio" value="Tunja" small />
        </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingRow}>
            ...
            <Text style={styles.settingValue}>Tunja ›</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  joined: { color: 'rgba(255,255,255,0.5)', fontSize: 12 },
